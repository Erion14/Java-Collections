...
public class ListPerformanceEvaluation {
	...
	public static void main(String[] args) {
		...
		System.out.println("100 element added into the beggining:" + add100ElementArrayListBeginning );
		...
		long remove100ElementsArrayListBeginning = (System.nanoTime()- mill) / 10000;
		System.out.println("100 Elements removed from the beginning: " + remove100ElementsArrayListBeginning);
...
//				+ remove10000000ElementLinkedListMiddle);
	 ...
	 public static void fillOutList(List<Integer> list, int amountOfElements) {
